 ...
 */
t_alloc_info *_get_alloc(size_t size, t_zone_info *zone, void *alloc_end)
{
...
void *_creat_client_mem_ptr(size_t size, t_zone_info *zone)
{
  size_t zone_size = _get_zone_mem_size(size, zone->alloc_type);
